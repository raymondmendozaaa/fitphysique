...
const Membership = () => {
    return (
        <motion.section 
          ...
          className="py-8 xl:py-0 lg:h-auto bg-membership bg-cover bg-center relative 
          before:w-full before:h-full before:bg-black/50 before:absolute before:top-0 
          before:z-10" 
          id="prices"
        >
            <div 
              className='container mx-auto px-0 text-white flex flex-col 
              xl:pt-14 relative z-20'>
                <motion.h2 
