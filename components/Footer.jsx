...
const Footer = () => {
  ...
  // Treat these as "app / dashboard" routes
  const isDashboardRoute =
    pathname?.startsWith("/member") ||
    pathname?.startsWith("/admin") ||
    pathname?.startsWith("/contract");

  // Only show the big marketing footer when:
  // - not logged in, OR
  // - not on a dashboard-style route
  const showFullFooter = !user || !isDashboardRoute;

  return (
    <footer
      className={showFullFooter ? "bg-primary-300 pt-24" : "bg-gray-900 pt-0"}
    >
      {showFullFooter && (
            ...
            <motion.div variants={footerItem}>
              ...
              <div className="flex flex-col gap-4">
                <p>
                  ...
                  Error quas nulla expedita blanditis.
                </p>
